define(['managerAPI', 'minno_mesh.js', 'https://cdn.jsdelivr.net/gh/minnojs/minno-datapipe@1.*/datapipe.min.js'], function (Manager, minno_mesh) {
    ...
    var noticeInst = 'At the bottom, you can see what your webcam shows. </br>' + 
     ...
     var MainInst = '<p>Your task is to blink with your eyes as quickly as possible when you hear <font style color="red">a beep</font>.</br></p>'+
                    '<p style="font-weight: bold;">Please look at the centre of the screen throughout the experiment.</p></br>'+
                     '<br/>' + 
	                noticeInst ;
	                
     var MainIns_m = '<p>Your task is to click on the spacebar as quickly as possible when you hear <font style color="red">a beep</font>.</br></p>'+
                    '<p style="font-weight: bold;">Please look at the centre of the screen throughout the experiment.</p></br>'+
                     '<br/>' + 
	                noticeInst ;
	...
	API.addTasksSet(
	{
		...
		aud_task :
		[{
			type: 'time', name: 'aud_task', scriptUrl: 'EBR_AUD.js' , 
			current: {
			    myID:'aud_task',
			    ...
			    blockInst: [
    	            '<div style="'+instStyle+'"><color="red">' +
                        '<p>In this part of the experiment you will be presented with a beep.</p>'+
                            MainIns_m+ 
